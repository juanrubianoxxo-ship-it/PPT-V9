...
.market-share strong { display:block; margin-top:.035in; color:var(--red); font-size:14pt; line-height:1; }
    ...
    .generator-only-layout { height:5.7in; }
    .generator-page-panel { min-width:0; padding:.02in 0; }
    .generator-grid-large { grid-template-columns:1fr 1fr; gap:.18in; }
    .generator-grid-large .generator-card { min-height:2.28in; grid-template-columns:2.55in 1fr; gap:.15in; padding:.12in; }
    .generator-grid-large .generator-img { width:2.55in; height:2in; }
