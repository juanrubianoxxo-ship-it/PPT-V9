...
def render(fields, sheets, images):
    ...
    for title, cards in [('Entorno | Generadores Vivienda', housing_cards), ('Entorno | Generadores Empleo', employment_cards)]:
        slides.append(slide(title, f'''
            <div class="generator-page-layout">
                <div class="visual-card intelligence-card">
                    {media(images.get('expansion_intelligence'), 'intelligence-photo', 'Carga la inteligencia de expansión', 'Inteligencia de expansión')}
                    <div class="visual-caption"><b>Inteligencia de expansión</b><span>Área de influencia y lectura del entorno</span></div>
                </div>
                <div class="generator-page-panel">
                    <div class="generator-page-heading"><span>REGISTRO FOTOGRÁFICO</span><strong>4 generadores organizados</strong></div>
                    <div class="generator-grid">{cards}</div>
