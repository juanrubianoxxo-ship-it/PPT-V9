...
if generate:
    ...
    slide_count = 12 if f.get('microsaturation_enabled') == 'Sí' else 11
    ...
    expansion_html = render_expansion(f, image_bytes)
    st.download_button(
        'Descargar presentación adicional de expansión',
        expansion_html.encode('utf-8'),
        file_name='presentacion_expansion_mercado_trafico.html',
        mime='text/html',
        width='stretch',
    )
